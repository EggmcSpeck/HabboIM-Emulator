    ...
    public sealed class SocketConnection : Socket, IDisposable
    {
        ...
        internal void method_1()
        {
            try
            {
                ...
                this.Close();
                this.Dispose();
                HabboIM.GetGame().GetClientManager().method_9(this.uint_0);
            }
            catch
            {
            }
        ...
        internal void SendData(byte[] byte_1)
        {
            if (!this.bool_0)
            {
                ...
                {
                    HabboIM.GetGame().GetClientManager().DisposeConnection(this);
                }
            }
        }
        ...
        {
            this.SendData(HabboIM.GetDefaultEncoding().GetBytes(string_1));
        }
