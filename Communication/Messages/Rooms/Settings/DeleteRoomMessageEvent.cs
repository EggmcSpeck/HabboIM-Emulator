...
namespace HabboIM.Communication.Messages.Rooms.Settings
{
	internal sealed class DeleteRoomMessageEvent : Interface
	{
		public void Handle(GameClient Session, ClientMessage Event)
		{
			...
			{
				HabboIM.GetGame().GetRoomManager().method_2(num);
				...
				{
					Room class2 = HabboIM.GetGame().GetRoomManager().GetRoom(@class.Id);
					if (class2 != null)
					{
