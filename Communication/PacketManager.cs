...
using HabboIM.Communication.Messages.Avatar;
using HabboIM.Communication.Messages.Wired;
using HabboIM.Communication.Messages.Sound;
using HabboIM.Communication.Messages.Register;
using HabboIM.Communication.Messages.Inventory.Badges;
using HabboIM.Communication.Messages.Recycler;
using HabboIM.Communication.Messages.Users;
using HabboIM.Communication.Messages.Inventory.Trading;
using HabboIM.Communication.Messages.Help;
using HabboIM.Communication.Messages.Rooms.Action;
using HabboIM.Communication.Messages.Rooms.Furniture;
using HabboIM.Communication.Messages.Rooms.Avatar;
using HabboIM.Communication.Messages.Rooms.Chat;
using HabboIM.Communication.Messages.Rooms.Engine;
using HabboIM.Communication.Messages.Rooms.Pets;
using HabboIM.Communication.Messages.Rooms.Session;
using HabboIM.Communication.Messages.Rooms.Settings;
using HabboIM.Communication.Messages.Navigator;
using HabboIM.Communication.Messages.Handshake;
using HabboIM.Communication.Messages.Messenger;
using HabboIM.Communication.Messages.Catalog;
using HabboIM.Communication.Messages.Marketplace;
using HabboIM.Communication.Messages.Inventory.AvatarFX;
using HabboIM.Communication.Messages.Inventory.Furni;
using HabboIM.Communication.Messages.Inventory.Purse;
using HabboIM.Communication.Messages.Inventory.Achievements;
using HabboIM.Communication.Messages.Quest;
using HabboIM.Communication.Messages.Rooms.Polls;
using HabboIM.Communication.Messages.SoundMachine;
using HabboIM.Communication.Messages.FriendStream;
namespace HabboIM.Communication
{
