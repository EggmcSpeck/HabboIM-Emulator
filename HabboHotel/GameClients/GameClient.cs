...
namespace HabboIM.HabboHotel.GameClients
{
    internal sealed class GameClient
    {
        ...
        {
            return HabboIM.GetGame().GetNavigator().method_12(this, -3);
        }
		...
		public void NotifyBan(string reason)
		{
			...
			Message.AppendStringWithBreak("Deine Verbindung wurde geschlossen!\n", 13);
		...
		public void method_12()
		{
			if (!this.bool_2)
			{
				HabboIM.GetGame().GetClientManager().method_9(this.Id);
				this.bool_2 = true;
			}
		}
