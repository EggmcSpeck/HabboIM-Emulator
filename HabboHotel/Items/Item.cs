...
namespace HabboIM.HabboHotel.Items
{
	internal sealed class Item
	{
        ...
        public Item(string sfx_id,  uint Id, int Sprite, string PublicName, string Name, string Type, int Width, int Length, double Height, bool Stackable, bool Walkable, bool IsSeat, bool AllowRecycle, bool AllowTrade, bool AllowMarketplaceSell, bool AllowGift, bool AllowInventoryStack, string InteractionType, int Modes, string VendingIds, string Height_Adjustable, byte EffectF, byte EffectM, bool HeightOverride)
		{
