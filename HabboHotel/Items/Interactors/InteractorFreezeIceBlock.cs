            ...
            try
            {
                ...
                if (User.Freezed == false)
                {
                    if (User.team != Rooms.Games.Team.None)
                    {
                        ...
                        {
                            if (Item.Int32_0 == User.X || Item.Int32_0 - 1 == User.X || Item.Int32_0 + 1 == User.X)
                            {
                                if (Item.Int32_1 == User.Y || Item.Int32_1 - 1 == User.Y || Item.Int32_1 + 1 == User.Y)
                                {
        ...
        public void FreezeUser(RoomItem Item, RoomItem Item2)
        {
            if (Item.method_8().frzTimer == true)
            {
                for (int i = 0; i < Item.method_8().RoomUsers.Length; i++)
                {
                    ...
                    if (User2 != null)
                    {
                        if (User2.X == Item2.Int32_0 && User2.Y == Item2.Int32_1)
                        {
