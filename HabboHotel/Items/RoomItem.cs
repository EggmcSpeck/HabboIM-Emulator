...
namespace HabboIM.HabboHotel.Items
{
    internal sealed class RoomItem
    {
            ...
            get
            {
                ...
                switch (text)
                {
                    case "ball":
                        ...
                        return result;
                    case "casinomachine":
                        result = new InteractorCasinoMachine();
                        return result;
                    case "teleport":
                    ...
                    case "wf_act_kick_user":
                        ...
                        return result;
                    case "atm_slitherio":
                        result = new InteractorSlitherIO();
                        return result;
                    case "knastarbeit":
                        result = new InteractorKnastarbeit();
                        return result;
                    case "atm_wingsio":
                        result = new InteractorWingsIO();
                        return result;
                    case "atm_vertix":
                        result = new InteractorVertixATM();
                        return result;
                    case "atm_bomberman":
                        result = new InteractorBomberman();
                        return result;
                    case "youtube_tv":
                        result = new InteractorYoutubeTV();
                        return result;
                    case "atm_browserquest":
                        result = new InteractorBrowserQuest();
                        return result;
                    ...
                    case "wf_act_yt":
                        ...
                        return result;
                    case "atm_doodlejump":
                        result = new InteractorDoodleJumpATM();
                        return result;
                    case "atm_flappybird":
                        result = new InteractorFlappyBirdATM();
                        return result;
                    case "atm_mario":
                        result = new InteractorMario();
                        return result;
                    case "atm_zelda":
                        result = new InteractorZelda();
                        return result;
                    case "atm_agario":
                        result = new InteractorAgarioATM();
                        return result;
                    case "atm_pacman":
                        result = new InteractorPacManATM();
                        return result;
                    case "stackfield":
                        result = new InteractorStackField();
                        return result;
                    case "atm_rd1":
                        result = new InteractorRD1();
                        return result;
                    case "atm_rd2":
                        result = new InteractorRD2();
                        return result;
                    case "atm_rd3":
                        result = new InteractorRD3();
                        return result;
                    case "atm_rd4":
                        result = new InteractorRD4();
                        return result;
                }
        ...
        public RoomItem(uint uint_5, uint uint_6, uint uint_7, string string_8, int int_5, int int_6, double double_1, int int_7, string string_9, Room class14_1)
        {
            ...
            this.Item = HabboIM.GetGame().GetItemManager().method_2(uint_7);
        ...
        internal void method_2()
        {
            ...
            if (this.int_4 <= 0)
            {
                ...
                switch (text)
                {
                                    ...
                                    if (ThreeDCoord.smethod_0(@class.Position, this.GStruct1_0))
                                    {
                                        ...
                                        if (TeleHandler.smethod_2(this.uint_0))
                                        {
                                            ...
                                            if (this.GetBaseItem().Name == "xmas10_fireplace")
                                            {
                                                ...
                                                @class.GetClient().GetHabbo().Figure = HabboIM.FilterString(look.ToLower());
                                            ...
                                            if (@class.int_19 == 0)
                                            {
                                                ...
                                                else
                                                {
                                                    if (!@class.IsBot)
                                                    {
                                                        HabboIM.GetGame().GetRoomManager().method_5(new TeleUserData(@class.GetClient().GetClientMessageHandler(), @class.GetClient().GetHabbo(), num3, num2));
                                                    }
                                                }
                                                this.uint_3 = 0u;
                                            }
                    ...
                    case "habbowheel":
                        {
                            int num = HabboIM.smethod_5(1, 10);
                            this.ExtraData = num.ToString();
                            this.method_4();
                            break;
                        }
                    ...
                    case "vendingmachine":
                        if (this.ExtraData == "1")
                        {
                            ...
                            {
                                @class.method_6();
                                int int_ = this.GetBaseItem().VendingIds[HabboIM.smethod_5(0, this.GetBaseItem().VendingIds.Count - 1)];
        ...
        internal void SerializeStackField(ServerMessage Message5_0)
        {
        ...
        internal Item GetBaseItem()
        {
            if (this.Item == null)
            {
                this.Item = HabboIM.GetGame().GetItemManager().method_2(this.uint_2);
            }
            return this.Item;
        }
        internal Room method_8()
        {
            ...
            {
                this.class14_0 = HabboIM.GetGame().GetRoomManager().GetRoom(this.uint_1);
            }
