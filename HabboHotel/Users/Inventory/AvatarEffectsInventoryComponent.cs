...
namespace HabboIM.HabboHotel.Users.Inventory
{
		...
		public void method_2(int int_1, bool bool_0)
		{
			if (this.method_4(int_1, true) || bool_0)
			{
				...
				if (@class != null && (this.method_8() != null && this.method_8().GetHabbo() != null))
				{
					...
					{
						this.int_0 = int_1;
                        if (class2.GetClient() != null && class2.GetClient().GetHabbo().CurrentQuestId > 0 && HabboIM.GetGame().GetQuestManager().GetQuestAction(class2.GetClient().GetHabbo().CurrentQuestId) == "SWIM" && (this.int_0 == 28 || this.int_0 == 29 || this.int_0 == 30 || this.int_0 == 37))
						{
                            HabboIM.GetGame().GetQuestManager().ProgressUserQuest(class2.GetClient().GetHabbo().CurrentQuestId, class2.GetClient());
						}
