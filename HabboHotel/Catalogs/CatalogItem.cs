...
namespace HabboIM.Catalogs
{
    internal sealed class CatalogItem
    {
        ...
        public CatalogItem(uint uint_3, string string_1, string string_2, int int_6, int int_7, int int_8, int int_9, int int_10, int int_11, uint uint_4, int song_id, string BadgeID, int LimitedSold, int LimitedCount)
        {
            this.uint_0 = uint_3;
        ...
        public Item method_0()
        {
            ...
            {
                result = HabboIM.GetGame().GetItemManager().method_2(this.list_0[0]);
            }
            return result;
        }
        ...
        public void method_1(ServerMessage Message5_0)
        {
            ...
            {
                int available = this.LimitedCount - this.LimitedSold;
                Message5_0.AppendStringWithBreak(string.Concat(new object[]
				{
					"LIMITIERT! ",
					available,
					"/",
            ...
            else if (this.string_0.StartsWith("disc_"))
            {
            ...
            else if (this.method_0().Name.StartsWith("poster_"))
            {
