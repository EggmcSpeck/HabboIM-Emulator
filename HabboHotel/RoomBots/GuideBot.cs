...
namespace HabboIM.HabboHotel.RoomBots
{
	internal sealed class GuideBot : BotAI
	{
		...
		{
			base.GetRoomUser().HandleSpeech(null, HabboIMEnvironment.GetExternalText("guidebot_welcome1"), true);
			base.GetRoomUser().HandleSpeech(null, HabboIMEnvironment.GetExternalText("guidebot_welcome2"), false);
		}
		...
		public override void OnTimerTick()
		{
			if (this.int_2 <= 0)
			{
				...
				this.int_2 = HabboIM.smethod_5(0, 150);
			}
			else
			{
				this.int_2--;
			...
			if (this.int_3 <= 0)
			{
				int int_ = HabboIM.smethod_5(0, base.method_1().RoomModel.int_4);
				int int_2 = HabboIM.smethod_5(0, base.method_1().RoomModel.int_5);
				base.GetRoomUser().MoveTo(int_, int_2);
				this.int_3 = HabboIM.smethod_5(0, 30);
			}
			else
			{
				this.int_3--;
