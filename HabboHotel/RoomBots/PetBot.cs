...
namespace HabboIM.HabboHotel.RoomBots
{
	internal sealed class PetBot : BotAI
	{
		...
		private void method_5(int int_4, int int_5, bool bool_0)
		{
			...
			if (bool_0)
			{
				int int_6 = HabboIM.smethod_5(0, base.method_1().RoomModel.int_4);
				int int_7 = HabboIM.smethod_5(0, base.method_1().RoomModel.int_5);
		...
		public override void OnTimerTick()
		{
            if (this.SpeechTimer <= 0)
			{
				...
				string[] array = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_dog1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_dog2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_dog3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_dog4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_dog5")
				};
				string[] array2 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_cat1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_cat2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_cat3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_cat4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_cat5")
				};
				string[] array3 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_croc1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_croc2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_croc3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_croc4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_croc5")
				};
				...
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_bear1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_bear2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_bear3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_bear4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_bear5")
				};
				string[] array6 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_pig1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_pig2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_pig3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_pig4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_pig5")
				};
				string[] array7 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_lion1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_lion2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_lion3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_lion4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_lion5")
				};
				string[] array8 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_rhino1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_rhino2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_rhino3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_rhino4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_rhino5")
				};
				string[] array9 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_spider1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_spider2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_spider3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_spider4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_spider5")
				};
				string[] array10 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_turtle1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_turtle2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_turtle3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_turtle4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_turtle5")
				};
				string[] array11 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_chic1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_chic2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_chic3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_chic4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_chic5")
				};
				string[] array12 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_frog1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_frog2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_frog3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_frog4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_frog5")
				};
				string[] array13 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_dragon1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_dragon2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_dragon3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_dragon4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_dragon5")
				};
				string[] array14 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_horse1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_horse2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_horse3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_horse4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_horse5")
				};
				string[] array15 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_monkey1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_monkey2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_monkey3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_monkey4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_monkey5")
				};
				string[] array16 = new string[]
				{
					HabboIMEnvironment.GetExternalText("pet_chatter_generic1"),
					HabboIMEnvironment.GetExternalText("pet_chatter_generic2"),
					HabboIMEnvironment.GetExternalText("pet_chatter_generic3"),
					HabboIMEnvironment.GetExternalText("pet_chatter_generic4"),
					HabboIMEnvironment.GetExternalText("pet_chatter_generic5")
				};
                ...
                this.SpeechTimer = HabboIM.smethod_5(30, 120);
			}
			else
			{
                this.SpeechTimer--;
