	...
	internal sealed class GuideBotMovement : BotAI
	{
		...
		public override void OnTimerTick()
		{
			if (this.int_2 <= 0)
			{
				...
				this.int_2 = HabboIM.smethod_5(10, 300);
			}
			else
			{
				this.int_2--;
			...
			if (this.int_3 <= 0)
			{
				...
				if (text != null && !(text == "stand"))
				{
					if (!(text == "freeroam"))
					{
						...
						{
							int int_ = HabboIM.smethod_5(base.method_3().min_x, base.method_3().max_x);
							int int_2 = HabboIM.smethod_5(base.method_3().min_y, base.method_3().max_y);
				...
				this.int_3 = HabboIM.smethod_5(1, 30);
			}
			else
			{
				this.int_3--;
